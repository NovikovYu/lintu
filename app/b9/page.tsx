  ...
  return (
    <MainBox>
      ...
      >
        ...
        <SurvayWrapper>
          <SurvayPartQuestionsWrapper>
            <BankDetailsFormTitle>Provide the following information to your  bank</BankDetailsFormTitle>
